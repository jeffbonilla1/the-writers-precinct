...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: 'You\'re In — Your Author Nation Discount Code',
      html: `
        <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; background: #0e0e0f; color: #e8e6e0; padding: 40px 32px;">
          <div style="font-family: Arial, sans-serif; font-size: 11px; letter-spacing: 3px; text-transform: uppercase; color: #c8782a; margin-bottom: 24px;">
            THE WRITERS PRECINCT — AUTHOR NATION 2026
          </div>
          ...
          <p style="font-size: 16px; color: #b0aea8; line-height: 1.7; margin-bottom: 32px; font-style: italic;">
            Your raffle entry is confirmed. One winner receives 3 months of full membership free — announced after Author Nation.
          </p>
          ...
          <p style="font-size: 14px; color: #b0aea8; line-height: 1.7; margin-bottom: 24px;">
            Use code <strong style="color: #e8e6e0;">AN2026</strong> at checkout on <a href="https://thewritersprecinct.com" style="color: #c8782a;">TheWritersPrecinct.com</a>. Code expires November 30, 2026. Limited to 500 redemptions.
          </p>
